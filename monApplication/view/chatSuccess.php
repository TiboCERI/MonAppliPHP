<div class="row">
  <div class="col s12 m4 l3 z-depth-3">
    ...
    <?php
      echo '
        ...
        <p>Nom    : '.$context->data['user']['nom'].' '.$context->data['user']['prenom'].'<a href="monApplication.php?action=edituser"><i class="material-icons">assignment</i></a></p>
  ...
  <div class="col s12 m4 l7 push-l1 z-depth-5"> 
    <form method="post" action="monApplication.php?action=tweetme" enctype="multipart/form-data">
        ...
        foreach($datatweet as $tweet) {
          ...
          echo '
            <li class="collection-item avatar z-depth-2">
              ...
              <p>'.$infopost->texte.'</br>
                <a href="././monApplication.php?action=vote&idtweet='.$tweet->id.'"><i class="material-icons">thumb_up</i></a> : '.$tweet->nbvotes.'
              </p>
            </li>
          ';
        }
